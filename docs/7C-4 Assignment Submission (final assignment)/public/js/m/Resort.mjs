...
import { collection as fsColl, deleteDoc, doc as fsDoc, getDoc, getDocs, orderBy,
  query as fsQuery, setDoc, Timestamp, startAt, limit, deleteField, updateDoc }
 ...
 * @type {{toFirestore: (function(*): {isbn: (Document.isbn|*), authorIdRefs: (Document.authorIdRefs|*),
 * title, publicationDate}), fromFirestore: (function(*, *=): Resort)}}
 */
Resort.converter = {
